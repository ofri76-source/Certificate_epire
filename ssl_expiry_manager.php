...
window.addEventListener('DOMContentLoaded',function(){
  ...
  if(createFormInstance){
    ...
    if(siteField){ siteField.addEventListener('input', updateDuplicates); siteField.addEventListener('blur', updateDuplicates); }
